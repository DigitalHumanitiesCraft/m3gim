...
Chronik regressions replace the retired single-anchor and independent-first-place helpers. Real source cases separate the 1953 rehearsal, performance and document dates in `NIM_023_5`, keep Zürich confined to its attesting context in `NIM_007_11`, and preserve undated contractual places in `NIM_005_16` and `NIM_005_17`. Other data tests cover identity deduplication, distinct parts, interval precision, malformed dates and pseudo-places. Browser checks unfold every source and entity at the dense 26 July 1953 group, open typed parts, follow exact evidence into Bestand, return focus on Escape, jump to a year and reach undated context. Combined-lane checks at 390, 800 and 1366 pixels preserve the filter and require no horizontal overflow. The smoke canaries now test date groups, source links, evidence panels and list expansion; missing structures fail.
