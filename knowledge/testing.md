...
Chronik data regressions verify source-specific document/statement separation in `NIM_023_5`, the Zürich context of `NIM_007_11`, undated contractual places in `NIM_005_16`/`NIM_005_17`, identity preservation, typed parts and exact evidence. Pure temporal geometry checks cover calendar precision, leap years, intervals, invalid/reversed values, qualifiers, window intersections, lossless label grouping and adaptive ticks. Browser checks exercise the continuous rail and proportional ranges, zoom and year navigation, complete dense-day sources/persons/parts, nested evidence and Bestand navigation, invalid/undated access, stable temporal geometry and focus on selection, and responsive dialog/column placement. Network checks preserve plot size, visible node geometry and zoom during shared-panel selection. Smoke canaries cover actual markers, source/group controls and complete evidence paths. The execution checkpoint in plan.md records the checked snapshot and scope.
