...
Chronik regressions replace the retired single-anchor and independent-first-place helpers. Real source cases separate the 1953 rehearsal, performance and document dates in `NIM_023_5`, keep Zürich confined to its attesting context in `NIM_007_11`, and preserve undated contractual places in `NIM_005_16` and `NIM_005_17`. Other data tests cover identity deduplication, distinct parts, interval precision, malformed dates and pseudo-places. Browser checks expose every source and entity at the dense 26 July 1953 group in the right panel while the timeline retains its three-entry previews. They open typed parts, follow source details and exact evidence into Bestand, return to complete lists, preserve scroll geometry and focus on Escape and dialog/desktop resize, jump to a year and reach the open undated group. Pure checks cover breaks between overlapping intervals. Combined-lane checks at 390, 800 and 1366 pixels preserve the filter and require no horizontal overflow. The smoke canaries now test date groups, source links, evidence panels and complete side-panel lists; missing structures fail.
