# Quellenindex der Knowledge Base

> Dieser Index dokumentiert Herkunft, Geltung und Pflegeart aller in der KB beruecksichtigten Markdown-Quellen.

## Statusschluessel

- **Kanonisch:** aktiv gepflegte Zielquelle
- **Anhang:** vollstaendig erhaltene Kontextquelle
- **Archiviert:** unveraenderte Vor-Refactor-Sicherung
- **Generiert:** wird durch Skript erzeugt

## Quellen

| Quelle | Typ | Status | Pflegeart | Bemerkung |
|---|---|---|---|---|
| `README.md` | Root-Dokumentation | Kanonisch | manuell | Einstieg und Repo-Rahmen |
| `scripts/README.md` | Pipeline-Dokumentation | Kanonisch | manuell | Ausfuehrungsanleitung |
| `MEETING-2026-02-24.md` | Arbeitsdokument | Kanonisch | manuell | komprimierte Meeting-Fassung |
| `knowledge/projekt-kontext.md` | KB-Kern | Kanonisch | manuell | Projekt- und Forschungsrahmen |
| `knowledge/system-architektur-pipeline.md` | KB-Kern | Kanonisch | manuell | Architektur und Pipeline |
