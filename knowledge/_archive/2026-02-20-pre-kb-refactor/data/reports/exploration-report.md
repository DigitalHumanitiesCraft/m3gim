# M³GIM Exploration Report

> Generiert: 2026-02-20 06:22
...
| Tabelle | Datei | Rows | Columns | Status |
|---|---|---|---|---|
| objekte | M3GIM-Objekte.xlsx | 282 | 18 | OK |
| verknuepfungen | M3GIM-Verknüpfungen.xlsx | 1264 | 6 | 1 Warnung(en) |
| personenindex | M3GIM-Personenindex.xlsx | 296 | 6 | 1 Warnung(en) |
| organisationsindex | M3GIM-Organisationsindex.xlsx | 58 | 6 | 1 Warnung(en) |
| ortsindex | M3GIM-Ortsindex.xlsx | 31 | 3 | 2 Warnung(en) |
| werkindex | M3GIM-Werkindex.xlsx | 95 | 6 | 1 Warnung(en) |

---

## objekte

**Datei:** `M3GIM-Objekte.xlsx` · **Sheets:** Objekte · **Zeilen:** 282

### Spalten

| Spalte | Typ | Füllgrad | Non-Null |
|---|---|---|---|
...
**Datei:** `M3GIM-Verknüpfungen.xlsx` · **Sheets:** Verknuepfungen · **Zeilen:** 1264
...
### Top-10 Objekte (nach Verknüpfungsanzahl)
...
**Datei:** `M3GIM-Personenindex.xlsx` · **Sheets:** Personenindex · **Zeilen:** 296
...
**Datei:** `M3GIM-Organisationsindex.xlsx` · **Sheets:** Organisationsindex · **Zeilen:** 58
...
**Datei:** `M3GIM-Ortsindex.xlsx` · **Sheets:** Ortsindex · **Zeilen:** 31
...
**Datei:** `M3GIM-Werkindex.xlsx` · **Sheets:** Werkindex · **Zeilen:** 95
...
### Verknüpfungen → Objekte [WARNUNG]

Verknüpfungen referenzieren existierende Objekte
