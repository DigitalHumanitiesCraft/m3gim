...
| **Statistik** | aktiv | Interaktives Dashboard des Bestandes (E-122): geteilte Sidebar-Shell mit record-basiertem Zeitraum-Filter und Panel-Schaltern, sechs Aggregat-Panels (Dokumenttypen, Mobilitätssichten, Geografie, Netzwerk, Repertoire, Finanzen) im Masonry-Grid, Tech-Reporting im Quality-Snapshot | gesamter Store, auf das Zeitfenster gefilterter Sub-Store | Sidebar links, Panel-Grid rechts, pure-function Aggregation pro Panel |
