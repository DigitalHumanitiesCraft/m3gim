...
Sidebar. Name, time window, document facets, person, place, work, institution, and the two view controls, the record nodes and the fading of actors with a single record. Nothing else, and the sidebar does not scroll. The coverage line stands at the view and names the visible records of the cut against all records of the fonds, with the records that carry a Verknüpfung and the date of the data state in its tooltip (E-277).
