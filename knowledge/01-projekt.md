...
> M³GIM = Mapping Mobile Musicians — Digitale Erschließung des Teilnachlasses Ira Malaniuk
...
| FF | Fokus | Frage |
|---|---|---|
| FF1 | Vernetzung | Wie prägten Sänger\*innen die Grazer Musik- und Theaterkultur? |
...
| FF4 | Mobilität | Welche Mobilitätsformen lassen sich bei Malaniuk identifizieren? |
...
|---|---|---|
| national | Staatsbürgerschaft durch Heirat | |
| geografisch | Pendelmobilität | |
| erzwungen | Flucht/Vertreibung | Flucht 1944 |
| bildung | Studium | |
| lebensstil | Persönliche Gründe | Zürich wegen Ehemann |
