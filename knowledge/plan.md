...
| M5c Evidence-path follow-up | Complete statistics evidence navigation and rehearse the task set against the recorded scope | Complete; independently reviewed and verified from a clean snapshot |
