...
| M5a Network interaction follow-up | Reduce the first selection cost with unchanged graph, evidence and keyboard behaviour; measure and independently review | Complete; independent comparison and interaction checks |
| M5b Source diagnostics follow-up | Regular validation reports exact Folio misses, impossible complete dates and rows dropped for missing content | Active; source data remains unchanged |
