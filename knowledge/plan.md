...
- Wikidata-Fehlmatches korrigieren (Sichtprüfung 2026-06-21, Reconciliation). „New York" ist über `wd:Q1384` auf den Bundesstaat statt die Stadt (`wd:Q60`) gematcht (Koordinaten 43 / -75 statt 40.7 / -74.0), betroffen sind drei STE (`absendeort` NIM_004_1, `zielort` NIM_004_23, `entstehung` NIM_004_27); gleiche Klasse wie der frühere Q2861-Rostock-Fall. Zudem mehrere Personen über gleichnamige, prominentere Entitäten fehlgematcht, im Interface an widersprüchlichen Berufs- und Lebensdaten erkennbar (Dermota als Politiker, Böhme als Ubootfahrer, Holm als Botaniker, Wächter als Maler, Wiener als Physiker, Richter als Tischtennisspieler). Über `verify-manual-approvals.py` plus eine Reconciliation-Prüfung dieser Namen korrigieren, gegebenenfalls manuelle Q-ID im Orts- bzw. Personenindex. Befunde R1/R2 in [frontend-sichtpruefung-2026-06-21.md](frontend-sichtpruefung-2026-06-21.md).
