...
| M5d Narrow network and knowledge follow-up | Keep the selected graph readable and its detail keyboard-reachable; reconcile stale open-model claims with the implemented behaviour | Complete; independently reviewed and verified from a clean snapshot, including test-environment follow-up |
