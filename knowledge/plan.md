...
| Map legend and geometry | Static legend is in the sidebar unlike Netzwerk; pies overlap and obscure labels | Evaluate a view-head legend for colour, size and placement together with the map proposal below |
