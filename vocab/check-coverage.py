...
role column that the schema explicitly treats as no role term (data-model.md § Financial layer).
"""
...
# Property that carries values of the role vocabulary (data-model.md § Roles as one property).
